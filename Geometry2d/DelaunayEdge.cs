...
{
    public struct DelaunayEdge : IEquatable<DelaunayEdge>
    {
        ...
        public bool Equals(DelaunayEdge e) => Point1 == e.Point1 && Point2 == e.Point2;
        public override bool Equals(object obj) => obj is DelaunayEdge edge && Equals(edge);
        public static bool operator == (DelaunayEdge e1, DelaunayEdge e2) => e1.Equals(e2);
        public static bool operator != (DelaunayEdge e1, DelaunayEdge e2) => !e1.Equals(e2);
